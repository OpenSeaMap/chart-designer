...
import osmcbdef.externaltools.ExternalToolDef;
import osmcbdef.externaltools.ExternalToolsLoader;
import osmcbdef.gui.actions.AddGpxTrackAreaPolygonMap;
import osmcbdef.gui.actions.AddGpxTrackPolygonMap;
import osmcbdef.gui.actions.AddMapLayer;
import osmcbdef.gui.actions.AtlasConvert;
import osmcbdef.gui.actions.AtlasCreate;
import osmcbdef.gui.actions.AtlasNew;
import osmcbdef.gui.actions.BookmarkAdd;
import osmcbdef.gui.actions.BookmarkManage;
import osmcbdef.gui.actions.DebugSetLogLevel;
import osmcbdef.gui.actions.DebugShowLogFile;
import osmcbdef.gui.actions.DebugShowMapSourceNames;
import osmcbdef.gui.actions.DebugShowMapTileGrid;
import osmcbdef.gui.actions.DebugShowReport;
import osmcbdef.gui.actions.HelpLicenses;
import osmcbdef.gui.actions.PanelShowHide;
import osmcbdef.gui.actions.RefreshCustomMapsources;
import osmcbdef.gui.actions.SelectionModeCircle;
import osmcbdef.gui.actions.SelectionModePolygon;
import osmcbdef.gui.actions.SelectionModeRectangle;
import osmcbdef.gui.actions.ShowAboutDialog;
import osmcbdef.gui.actions.ShowHelpAction;
import osmcbdef.gui.actions.ShowReadme;
import osmcbdef.gui.atlastree.JAtlasTree;
import osmcbdef.gui.components.FilledLayeredPane;
import osmcbdef.gui.components.JAtlasNameField;
import osmcbdef.gui.components.JBookmarkMenuItem;
import osmcbdef.gui.components.JCollapsiblePanel;
import osmcbdef.gui.components.JMenuItem2;
import osmcbdef.gui.components.JZoomCheckBox;
import osmcbdef.gui.listeners.AtlasModelListener;
import osmcbdef.gui.mapview.GridZoom;
import osmcbdef.gui.mapview.JMapViewer;
import osmcbdef.gui.mapview.PreviewMap;
import osmcbdef.gui.mapview.WgsGrid.WgsDensity;
import osmcbdef.gui.mapview.controller.JMapController;
import osmcbdef.gui.mapview.controller.PolygonCircleSelectionMapController;
import osmcbdef.gui.mapview.controller.PolygonSelectionMapController;
import osmcbdef.gui.mapview.controller.RectangleSelectionMapController;
import osmcbdef.gui.mapview.interfaces.MapEventListener;
import osmcbdef.gui.panels.JCoordinatesPanel;
import osmcbdef.gui.panels.JGpxPanel;
import osmcbdef.gui.panels.JProfilesPanel;
import osmcbdef.gui.panels.JTileImageParametersPanel;
import osmcbdef.gui.settings.SettingsGUI;
...
import osmcbdef.program.interfaces.InitializableMapSource;
import osmcbdef.program.interfaces.MapSource;
import osmcbdef.program.model.Bookmark;
import osmcbdef.program.model.MapSelection;
import osmcbdef.program.model.MercatorPixelCoordinate;
...
import osmcbdef.program.model.SettingsWgsGrid;
import osmcbdef.program.model.TileImageParameters;
import osmcbdef.utilities.GBC;
...
public class MainGUI extends JFrame implements MapEventListener
{
	...
	public static final ArrayList<Image> OSMCB_ICONS = new ArrayList<Image>(3);

	static
	{
		OSMCB_ICONS.add(Utilities.loadResourceImageIcon("osmcbdef48.png").getImage());
		OSMCB_ICONS.add(Utilities.loadResourceImageIcon("osmcbdef32.png").getImage());
		OSMCB_ICONS.add(Utilities.loadResourceImageIcon("osmcbdef16.png").getImage());
	}
