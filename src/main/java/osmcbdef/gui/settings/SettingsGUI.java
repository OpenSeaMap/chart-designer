...
import osmcbdef.StartOSMCBDef;
import osmcbdef.exceptions.UpdateFailedException;
import osmcbdef.gui.MainGUI;
import osmcbdef.gui.actions.OpenInWebbrowser;
import osmcbdef.gui.components.JDirectoryChooser;
import osmcbdef.gui.components.JMapSizeCombo;
import osmcbdef.gui.components.JTimeSlider;
...
import osmcbdef.program.model.MapSourcesListModel;
import osmcbdef.program.model.ProxyType;
import osmcbdef.program.model.Settings;
import osmcbdef.program.model.UnitSystem;
...
public class SettingsGUI extends JDialog {
	...
	private SettingsGUI(JFrame owner) {
		super(owner);
		setIconImages(MainGUI.OSMCB_ICONS);
