...
import osmcbdef.exceptions.MapSourceInitializationException;
import osmcbdef.mapsources.MapSourceUrlUpdater;
...
public class CloudMade extends AbstractOsmMapSource {
	...
	static {
		...
		try {
			Class<?> c = Class.forName("osmcbdef.mapsources.custom.CustomCloudMade");
