...
import osmcbdef.utilities.Juli2Log4jHandler;
import osmcbdef.utilities.OSUtilities;
...
public class Logging {
	...
	public static void logSystemInfo() {
		...
		if (log.isInfoEnabled()) {
			...
			log.info("Startup arguments (count=" + StartOSMCBDef.ARGS.length + "):");
			for (int i = 0; i < StartOSMCBDef.ARGS.length; i++)
				log.info("\t" + i + ": " + StartOSMCBDef.ARGS[i]);
		}
