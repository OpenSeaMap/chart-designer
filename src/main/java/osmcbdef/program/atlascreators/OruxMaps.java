...
import osmcbdef.program.atlascreators.impl.MapTileBuilder;
import osmcbdef.program.atlascreators.impl.MapTileWriter;
import osmcbdef.program.atlascreators.tileprovider.CacheTileProvider;
...
public class OruxMaps extends AtlasCreator {
	...
	/*
	 * @see osmcbdef.program.atlascreators.AtlasCreator#initLayerCreation(osmcbdef.program .interfaces.LayerInterface)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see osmcbdef.program.atlascreators.AtlasCreator#initializeMap(osmcbdef.program. interfaces.MapInterface,
	 * osmcbdef.utilities.tar.TarIndex)
	 */
	@Override
