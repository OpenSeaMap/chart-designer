...
public class OsmcbTile {
	...
	public OsmcbTile(TileProvider tileProvider, MapSpace mapSpace, int tilex, int tiley, int zoom) {
	...
	public String toString() {
		return String.format("OsmcbTile x/y [%d/%d] = %s", tilex, tiley, boundingRect);
	}
