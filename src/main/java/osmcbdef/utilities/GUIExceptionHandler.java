...
import osmcbdef.program.interfaces.ExceptionExtendedInfo;
...
public class GUIExceptionHandler implements Thread.UncaughtExceptionHandler, ExceptionListener {
	...
	private static final String URL_BUGTRACKER = "http://sourceforge.net/p/osmcbdef/bugs/";
	...
	public static void registerForCurrentThread() {
		...
		log.trace("Registering OSMCB exception handler for thread \"" + t.getName() + "\" [" + t.getId() + "]");
