...
public class MainFrame extends JFrame implements MapEventListener
{
	...
	private void saveSettings()
	{
		...
		catch (Exception e)
		{
			...
			JOptionPane.showMessageDialog(null, OSMCDStrs.RStr("msg_settings_write_error"), OSMBStrs.RStr("Error"), JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	private void updateZoomLevelCheckBoxes()
	{
		...
		{
			// int cbz = i + tileSource.getMinZoom(); // #zoom0-3
			int cbz = i + minZoom;
