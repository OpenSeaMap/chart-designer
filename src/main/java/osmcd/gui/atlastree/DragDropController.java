	...
	protected class AtlasDropTarget implements DropTargetListener
	{
		...
		protected void mergeLayers(AtlasTreeModel atlasTreeModel, LayerInterface sourceLayer, LayerInterface targetLayer) throws InvalidNameException
		{
			int answer = JOptionPane.showConfirmDialog(null,
					String.format(I18nUtils.localizedStringForKey("msg_confirm_merge_layer"), sourceLayer.getName(), targetLayer.getName()),
			...
			{
				JOptionPane.showMessageDialog(null, e.getMessage(), I18nUtils.localizedStringForKey("msg_merge_layer_failed"), JOptionPane.ERROR_MESSAGE);
				throw e;
			}
		}
