...
public class DragDropController
{
	...
	public DragDropController(JBundleTree atlasTree)
	{
		super();
	...
	protected class AtlasDragSource implements DragSourceListener, DragGestureListener
	{
		...
		public void dragGestureRecognized(DragGestureEvent dge)
		{
			...
			if (!(oldNode instanceof IfLayer || oldNode instanceof IfMap)) return;
	...
	protected class AtlasDropTarget implements DropTargetListener
	{
		...
		public synchronized void drop(DropTargetDropEvent dtde)
		{
			try
			{
				...
				BundleTreeModel atlasTreeModel = (BundleTreeModel) atlasTree.getModel();
				if (sourceNode instanceof IfLayer && targetNode instanceof IfLayer) mergeLayers(atlasTreeModel, (IfLayer) sourceNode, (IfLayer) targetNode);
				...
				if (sourceNode instanceof IfMap && targetNode instanceof IfLayer) moveMap(atlasTreeModel, (IfMap) sourceNode, (IfLayer) targetNode);
		...
		protected void mergeLayers(BundleTreeModel atlasTreeModel, IfLayer sourceLayer, IfLayer targetLayer) throws InvalidNameException
		{
		...
		protected void moveMap(BundleTreeModel atlasTreeModel, IfMap map, IfLayer targetLayer) throws InvalidNameException
		{
