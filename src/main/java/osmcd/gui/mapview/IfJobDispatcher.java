...
public class IfJobDispatcher implements ThreadFactory, RejectedExecutionHandler
{
	private static final Logger log = Logger.getLogger(IfJobDispatcher.class);
	private static final IfJobDispatcher INSTANCE = new IfJobDispatcher();
	...
	/**
	 * @return the singleton instance of the {@link IfJobDispatcher}
	 */
	public static IfJobDispatcher getInstance()
	{
		return INSTANCE;
	}
