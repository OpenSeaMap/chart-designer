...
import osmcd.exceptions.MapSourceInitializationException;
import osmcd.mapsources.MapSourceUrlUpdater;
...
public class CloudMade extends AbstractOsmMapSource {
	...
	static {
		...
		try {
			Class<?> c = Class.forName("osmcd.mapsources.custom.CustomCloudMade");
