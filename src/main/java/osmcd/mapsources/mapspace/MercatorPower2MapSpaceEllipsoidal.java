 ...
 ******************************************************************************/
package osmcd.mapsources.mapspace;
...
public class MercatorPower2MapSpaceEllipsoidal extends MercatorPower2MapSpace {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see osmcd.mapsources.mapspace.MercatorPower2MapSpace#cLatToY(double, int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see osmcd.mapsources.mapspace.MercatorPower2MapSpace#cYToLat(int, int)
	 */
	@Override
