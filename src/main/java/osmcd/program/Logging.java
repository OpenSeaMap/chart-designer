...
import osmcd.utilities.Juli2Log4jHandler;
...
public class Logging
{
	...
	public static void logSystemInfo()
	{
		...
		if (log.isInfoEnabled())
		{
			...
			log.info("Startup arguments (count=" + StartOSMCD.ARGS.length + "):");
			for (int i = 0; i < StartOSMCD.ARGS.length; i++)
				log.info("\t" + i + ": " + StartOSMCD.ARGS[i]);
		}
