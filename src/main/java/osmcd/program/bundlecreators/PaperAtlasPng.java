...
import osmcb.exceptions.BundleTestException;
import osmcb.exceptions.MapCreationException;
import osmcb.program.annotations.ChartBundleName;
...
@ChartBundleName(value = "Paper Bundle (PNG)")
public class PaperAtlasPng extends PaperAtlas
{
	...
	public void createMap(IfMap map) throws MapCreationException, InterruptedException
	{
		...
		try
		{
			OSMCBUtilities.mkDirs(mapFolder);
		}
		catch (IOException e)
		{
	...
	@Override
	public void finishBundle(IfBundle bundle) throws IOException
	{
