...
/**
 * 
 * Extended version of {@link TarArchive} that automatically creates the TrekBuddy tmi-file while writing the archive entries.
 * 
 * @author r_x
 * 
 * @see <a href="http://www.linuxtechs.net/kruch/tb/forum/viewtopic.php?t=897"> TrekBuddy tmi map tar index file description< /a>
 */
public class TarTmiArchive extends TarArchive
{
	...
	public TarTmiArchive(File tarFile, File baseDir) throws IOException {
		...
		tmiWriter = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(tmiFilename + ".tmi"), ChartBundle.TEXT_FILE_CHARSET));
	}
